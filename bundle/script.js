...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <ul class=\"country__descr\">\n        <li>"
    ...
    + "</li>\n        <li>Capital: "
    + alias4(((helper = (helper = lookupProperty(helpers,"capital") || (depth0 != null ? lookupProperty(depth0,"capital") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"capital","hash":{},"data":data,"loc":{"start":{"line":5,"column":21},"end":{"line":5,"column":32}}}) : helper)))
    + "</li>\n        <li>Population: "
    + alias4(((helper = (helper = lookupProperty(helpers,"population") || (depth0 != null ? lookupProperty(depth0,"population") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"population","hash":{},"data":data,"loc":{"start":{"line":6,"column":24},"end":{"line":6,"column":38}}}) : helper)))
    + " people</li>\n        <li>Languages: <ul>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"languages") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":8,"column":12},"end":{"line":10,"column":21}}})) != null ? stack1 : "")
    + "        </ul></li>\n        <li><img src="
    + alias4(container.lambda(((stack1 = (depth0 != null ? lookupProperty(depth0,"flags") : depth0)) != null ? lookupProperty(stack1,"svg") : stack1), depth0))
    + " width=\"64\" height=\"32\"></li>\n    </ul>\n";
  ...
  return "<div class=\"one__country\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":4},"end":{"line":14,"column":13}}})) != null ? stack1 : "")
    + "</div>";
},"useData":true});
...
var update = injectStylesIntoStyleTag_default()((dist_PNotify_default()), options);
...
var styles_update = injectStylesIntoStyleTag_default()((styles_default()), styles_options);
...
// EXTERNAL MODULE: ./src/templates/countries.hbs
var templates_countries = __webpack_require__(964);
var countries_default = /*#__PURE__*/__webpack_require__.n(templates_countries);
// EXTERNAL MODULE: ./src/templates/country.hbs
var country = __webpack_require__(781);
var country_default = /*#__PURE__*/__webpack_require__.n(country);
;// CONCATENATED MODULE: ./src/js/searchClass.js
...
var Search = function Search(_ref, URL) {
  var _this = this;
  ...
  _defineProperty(this, "addListeners", function () {
    addEventListener('input', lodash_default().debounce(_this.searchCountry, 1000));
  });

  _defineProperty(this, "searchCountry", function (event) {
    _this.countriesData.innerHTML = '';
    ...
    _this.fetchDataFromInput(value);
  });

  _defineProperty(this, "fetchDataFromInput", function (value) {
    return fetch(_this.URL + value).then(function (res) {
      return res.json();
    }).then(function (countries) {
      if (countries.status === 404) {
        var Myerror = (0,PNotify.error)({
      ...
      if (len > 1 && len < 10) {
        var markup = countries_default()(countries);
        _this.countriesData.innerHTML = markup;
      }

      if (len === 1) {
        _this.root.innerHTML = '';

        var _markup = country_default()(countries);

        _this.root.innerHTML = _markup;
      }
    })["catch"](function (err) {
      var myErr = (0,PNotify.error)({
        text: "".concat(err)
      });
    });
  });
...
/* harmony default export */ const searchClass = (Search);
;// CONCATENATED MODULE: ./src/js/refs.js
var refs = {
  input: document.querySelector('input[type="search"]'),
  div: document.querySelector('.searchfield'),
  root: document.querySelector('.root'),
  countriesData: document.querySelector('#countries')
};
...
new searchClass(js_refs, 'https://restcountries.com/v2/name/').addListeners(); // import template from './templates/menu-template.handlebars'
